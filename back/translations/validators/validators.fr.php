...
return [
    'name.not_blank' => 'Le nom ne doit pas être vide',
    'email.not_blank' => 'L\'adresse email ne doit pas être vide',
    ...
    'password.identical_to' => 'Les mot de passe doivent être identiques',
];