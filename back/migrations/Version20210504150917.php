 ...
 */
final class Version20210504150917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE characters (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, inventory_id INT NOT NULL, race_id INT NOT NULL, profession_id INT NOT NULL, name VARCHAR(100) NOT NULL, sex VARCHAR(1) NOT NULL, level INT NOT NULL, INDEX IDX_3A29410E7E3C61F9 (owner_id), UNIQUE INDEX UNIQ_3A29410E9EEA759 (inventory_id), INDEX IDX_3A29410E6E59D40D (race_id), INDEX IDX_3A29410EFDEF8996 (profession_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE monster (id INT AUTO_INCREMENT NOT NULL, wandering_monster_group_id INT DEFAULT NULL, caracteristics_id INT NOT NULL, special_object_id INT DEFAULT NULL, place_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, is_boss TINYINT(1) NOT NULL, has_booster TINYINT(1) NOT NULL, level INT NOT NULL, picture JSON DEFAULT NULL, INDEX IDX_245EC6F446F0AD06 (wandering_monster_group_id), UNIQUE INDEX UNIQ_245EC6F45D20926C (caracteristics_id), INDEX IDX_245EC6F44DC6EDA7 (special_object_id), INDEX IDX_245EC6F4DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, scenario_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, hidden_booster_count INT NOT NULL, picture JSON DEFAULT NULL, INDEX IDX_741D53CD12469DE2 (category_id), INDEX IDX_741D53CDE04E49DF (scenario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE scenario (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, max_players INT DEFAULT NULL, character_level INT NOT NULL, picture JSON DEFAULT NULL, INDEX IDX_3E45C8D87E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(100) NOT NULL, avatar JSON DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE characters ADD CONSTRAINT FK_3A29410E7E3C61F9 FOREIGN KEY (owner_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE characters ADD CONSTRAINT FK_3A29410E9EEA759 FOREIGN KEY (inventory_id) REFERENCES inventory (id)');
        $this->addSql('ALTER TABLE characters ADD CONSTRAINT FK_3A29410E6E59D40D FOREIGN KEY (race_id) REFERENCES race (id)');
        $this->addSql('ALTER TABLE characters ADD CONSTRAINT FK_3A29410EFDEF8996 FOREIGN KEY (profession_id) REFERENCES profession (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characters_game DROP FOREIGN KEY FK_F0A363B8C70F0E28');
        $this->addSql('ALTER TABLE characters_game DROP FOREIGN KEY FK_F0A363B8E48FD905');
        $this->addSql('ALTER TABLE characters DROP FOREIGN KEY FK_3A29410E9EEA759');
        ...
        $this->addSql('ALTER TABLE characters DROP FOREIGN KEY FK_3A29410EFDEF8996');
